...
const specs: Record<BackupTable, TableSpec> = {
  ...
  customers: { exportColumns: ['id', 'full_name', 'phone', 'address', 'credit_limit', 'created_at', 'updated_at', 'deleted_at'], restoreColumns: ['id', 'full_name', 'phone', 'address', 'credit_limit', 'created_at', 'updated_at', 'deleted_at', 'origin_device_id'], numeric: ['credit_limit'] },
  sales: { exportColumns: ['id', 'transaction_number', 'customer_id', 'cashier_id', 'payment_method', 'subtotal', 'discount', 'total', 'cash_received', 'change_amount', 'reference_number', 'status', 'created_at', 'updated_at', 'deleted_at'], restoreColumns: ['id', 'transaction_number', 'customer_id', 'cashier_id', 'payment_method', 'subtotal', 'discount', 'total', 'cash_received', 'change_amount', 'reference_number', 'status', 'created_at', 'updated_at', 'deleted_at', 'origin_device_id'], numeric: ['subtotal', 'discount', 'total', 'cash_received', 'change_amount'] },
...
export async function restoreBackup(backup: SariStoreBackup) {
  ...
  await runInTransaction(async (db) => {
    ...
    await insertRows(db, 'customers', valid.data.customers, (row) => ({ ...row, origin_device_id: null }));
    await insertRows(db, 'sales', valid.data.sales, (row) => ({ ...mapUserReferences(row, ['cashier_id']), origin_device_id: null }));
